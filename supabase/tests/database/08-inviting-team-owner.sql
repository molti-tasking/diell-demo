...
-- create invitation
SELECT row_eq(
               $$ insert into public.invitations (organization_id, account_role, token, invitation_type) values ('d126ecef-35f6-4b5d-9f28-d9f00a9fb46f', 'owner', 'test_owner_single_use_token', 'one_time') returning 1 $$,
               ROW (1),
